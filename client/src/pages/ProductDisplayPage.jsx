        ...
        <div className="my-4 hidden lg:grid gap-3 ">
          ...
          {data?.more_details &&
            Object?.keys(data?.more_details)?.map((element, index) => {
              return (
                <div key={element + index} className="">
      ...
      <div className="p-4 lg:p-7 text-base lg:text-lg">
        ...
        <div className="">
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            <div className="border border-green-600 px-4 py-1 rounded bg-green-50 w-fit">
            ...
            {data.discount && (
              <p className="line-through text-neutral-600 text-lg">
                {DisplayPriceInEuro(data.price)}
              </p>
            )}
            {data.discount && (
        ...
        <div className="">
          <div className="flex gap-4 items-center my-2">
            ...
            <div className="text-sm">
              ...
              <p>
                Il tuo ordine verrà consegnato a domicilio al più presto dal
          ...
          <div className="flex gap-4 items-center my-2">
            ...
            <div className="text-sm">
              ...
              <p>Miglior prezzo con offerte direttamente dal produttore.</p>
            </div>
          </div>
          <div className="flex gap-4 items-center my-2">
            <img src={image3} alt="Best prices offers" className="w-20 h-20" />
            <div className="text-sm">
              <div className="font-semibold">Wide Assortment</div>
              <p>Scegli tra i tanti prodotti disponibili.</p>
            </div>
          </div>
        </div>
