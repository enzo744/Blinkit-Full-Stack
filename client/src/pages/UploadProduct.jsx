      ...
      <div className="grid p-3">
        <form className="grid gap-4" onSubmit={handleSubmit}>
          ...
          <div className="">
            ...
            <div className="">
              <label htmlFor="productImage" className="bg-blue-50 h-24 border rounded-md flex items-center justify-center cursor-pointer">
              ...
              <div className="flex flex-wrap gap-3">
                {
                  data.image.map((img, index) =>{
                    return (
                      <div key={img+index} className="h-20 w-20 mt-1 min-w-20 bg-blue-50 border rounded-md relative group">
                        <img 
                          src={img} 
                          alt={img} 
              ...
              <div className="flex flex-wrap gap-3">
                {
                  data.category.map((c,index)=>{
                    return (
                      <div key={c._id+index+"productsection"} className="text-sm flex items-center gap-1 bg-blue-50 mt-1 border rounded">
                        <p>{c.name}</p>
                        <div onClick={()=>handleRemoveCategory(index)} className="cursor-pointer hover:text-red-500" >
                          <IoClose size={20} />
                        </div>
                      </div>
                    )
              ...
              <div className="flex flex-wrap gap-3">
                {
                  data.subCategory.map((c,index)=>{
                    return (
                      <div key={c._id+index+"subCategory"} className="text-sm flex items-center gap-1 bg-blue-50 mt-1 border rounded">
                        <p>{c.name}</p>
                        <div onClick={()=>handleRemoveSubCategory(index)} className="cursor-pointer hover:text-red-500" >
                          <IoClose size={20} />
                        </div>
                      </div>
                    )
          ...
          {/* stock */}
          <div className="grid gap-1">
            <label htmlFor="stock" className="font-medium" >Nr. of Stock</label>
            <input 
              id="stock"
              type="number" 
