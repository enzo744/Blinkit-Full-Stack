        ...
        <div className="container mx-auto flex items-center px-2 justify-between">
          ...
          <div className="">
            ...
            <button onClick={handleMobileUser} className="text-neutral-600 lg:hidden">
              <FaRegCircleUser size={26} className="" />
            </button>
              ...
              {user._id ? (
                <div className="relative">
                  ...
                  >
                    <p>Account</p>
                    {openUserMenu ? (
                      <GoTriangleUp size={25} className="text-neutral-600" />
                    ) : (
                      <GoTriangleDown size={25} className="text-neutral-600" />
                    )}
                  </div>
                  {openUserMenu && (
                ...
                <div className="font-semibold text-sm">
                  {
                    cartItem[0] ? (
                      <div>
                        <p>{totalQty} Items</p>
                        <p>{DisplayPriceInEuro(totalPrice)}</p>
                      </div>
                    ): (
                      <p>My Cart</p>
                    )
